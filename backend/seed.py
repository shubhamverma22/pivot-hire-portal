    ...
    async with async_session() as db:
        ...
        jobs_data = [
            Job(company_user_id=company1.id, title="Senior Product Manager", role_type=JobType.FULL_TIME,
                location="Bangalore, India", salary_min=2500000, salary_max=4000000, currency="INR",
            ...
            Job(company_user_id=company1.id, title="DevOps Lead", role_type=JobType.REMOTE,
                location="Remote (India)", salary_min=2000000, salary_max=3500000, currency="INR",
            ...
            Job(company_user_id=company1.id, title="Engineering Manager", role_type=JobType.FULL_TIME,
                location="Mumbai, India", salary_min=3000000, salary_max=5000000, currency="INR",
            ...
            Job(company_user_id=company2.id, title="Backend Engineer — Python", role_type=JobType.FULL_TIME,
                location="Hyderabad, India", salary_min=1800000, salary_max=3000000, currency="INR",
            ...
            Job(company_user_id=company2.id, title="Head of Growth", role_type=JobType.FULL_TIME,
                location="Delhi NCR, India", salary_min=2800000, salary_max=4500000, currency="INR",
            ...
            Job(company_user_id=company2.id, title="Data Analyst Intern", role_type=JobType.INTERNSHIP,
                location="Remote", salary_min=15000, salary_max=25000, currency="INR",
        ...
        apps = [
            ...
            Application(candidate_id=founder3.id, job_id=jobs_data[4].id,
                cover_letter="Grew LearnLoop to 10K users with zero marketing budget. Growth is what I do.",
                status=ApplicationStatus.APPLIED),
        ]
        db.add_all(apps)
        await db.commit()
