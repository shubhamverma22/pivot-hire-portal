  ...
  return (
    <a href="/" style={{ display:'flex', alignItems:'center', textDecoration:'none', lineHeight:1 }}>
      <div style={{ display:'flex', flexDirection:'column', gap: size * 0.04 }}>
        <span style={{ fontFamily:'Syne, sans-serif', fontWeight:800, fontSize: lineH, color: pivotColor, letterSpacing:'0.5px', lineHeight:1, display:'block' }}>PIVOT</span>
        <span style={{ fontFamily:'Syne, sans-serif', fontWeight:800, fontSize: lineH, color: hireColor, letterSpacing:'0.5px', lineHeight:1, display:'flex', alignItems:'center', gap: lineH * 0.2 }}>
          HIRE
...
export function PivotHireLogoInline({ size = 14, dark = false }) {
  ...
  return (
    <a href="/dashboard" style={{ display:'flex', alignItems:'center', textDecoration:'none', lineHeight:1, gap: size * 0.25 }}>
      <span style={{ fontFamily:'Syne, sans-serif', fontWeight:800, fontSize: size, color: pivotColor, letterSpacing:'0.5px' }}>PIVOT</span>
      <span style={{ fontFamily:'Syne, sans-serif', fontWeight:800, fontSize: size, color: hireColor, letterSpacing:'0.5px', display:'flex', alignItems:'center', gap: size * 0.15 }}>
        HIRE
